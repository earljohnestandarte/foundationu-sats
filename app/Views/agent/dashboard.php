...
<section class="section-padding">
    <div class="mb-4">
        ...
        <p style="color: var(--fu-on-surface-variant);">Review tickets for your office and take action with a streamlined view.</p>
    </div>
    ...
    <div class="card-fu">
        <div class="d-flex justify-content-between align-items-center px-4 py-3" style="border-bottom: 1px solid var(--fu-outline-variant); background-color: var(--fu-surface-container-low);">
            <h4 class="fw-semibold mb-0" style="color: var(--fu-primary); font-size: 20px;">All Tickets</h4>
        </div>
        ...
        <?php if (empty($tickets)): ?>
            <div class="p-5 text-center">
                ...
                <p class="text-muted">No tickets are currently assigned to your office.</p>
            </div>
        <?php else: ?>
