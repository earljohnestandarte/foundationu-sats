    ...
    <div class="mb-4">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
            <div>
                ...
                <p style="color: var(--fu-on-surface-variant);">Closed and archived concerns.</p>
            </div>
            <a href="<?= site_url('student/tickets') ?>" class="btn btn-fu-primary d-flex align-items-center gap-2">
    ...
    <div class="card-fu">
        <?php if (empty($tickets)): ?>
            <div class="p-5 text-center">
                ...
                <p class="text-muted">Closed concerns will appear here.</p>
            </div>
        <?php else: ?>
